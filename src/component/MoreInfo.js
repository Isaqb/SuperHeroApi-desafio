    ...
    return (
        <div ref={modalRef} id={heros.id} heros={heros} className='modal'>
            ...
            <div className="box-ap">
                <div className="box">                    <h2><b>Appearance</b></h2>
                ...
                <div className="box"><h2><b>Powerstats</b></h2>
                ...
                <div className="box"><h2><b>Biography</b></h2>
                ...
                <div className="box"> <h2><b>Work</b></h2>
                    <p><b>Occupation: </b>{heros.work.occupation}</p>
                    <p><b>Base:</b>{heros.work.base}</p>
                </div>


                <div className="box"> <h2><b>Connection</b></h2>
